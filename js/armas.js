...
//video
var $videoChapter6 = 	$("#vid-c-6"),
		$videoChapter6Title = $videoChapter6.find(".chapter-title"),
...
new ScrollMagic.Scene({triggerElement: "#bottomLauncher"})
...
window.onload = function(){
	...
	setTimeout(function(){
		$videoChapter6Title.addClass('visible');
	}, 1000);
...
function scrollToText(){
	...
	var vchaper1 = $videoChapter6.height();
	// if (window.height) {
	// 	expression
	// }
...
function launchVideo(){
	$videoChapter6.find('video')[0].muted = true;
	$videoChapter6.find('video')[0].play();
};
