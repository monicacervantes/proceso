...
//video
var $videoChapter3 = 	$("#vid-c-3"),
		$videoChapter3Title = $videoChapter3.find(".chapter-title"),
...
window.onload = function(){
	...
	setTimeout(function(){
		$videoChapter3Title.addClass('visible');
	}, 1000);
...
function scrollToText(){
	...
	var vchaper1 = $videoChapter3.height();
	// if (window.height) {
	// 	expression
	// }
...
function launchVideo(){
	$videoChapter3.find('video')[0].play();
};
